                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="solution"><g:message code="dataKeeper.solution.label" default="Solution" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: dataKeeperInstance, field: 'solution', 'errors')}">
                                    
<ul>
<g:each in="${dataKeeperInstance?.solution?}" var="s">
